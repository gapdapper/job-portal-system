...
import com.jobportal.jobportal.config.JwtService;
import com.jobportal.jobportal.token.Token;
import com.jobportal.jobportal.token.TokenRepository;
import com.jobportal.jobportal.token.TokenType;
...
public class AuthenticationService {
  ...
  public AuthenticationResponse register(RegisterRequest request) {
    User user = User.builder()
            ...
            .roles(List.of(Role.ROLE_APPLICANT))
            .build();
